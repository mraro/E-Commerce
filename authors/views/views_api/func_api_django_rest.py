...
def api_dashboard(request):
    remedios = models.E_Commerce.objects.filter(is_published=False, author=request.user)
...
def api_edit_obj(request, pk):
    remedio = models.E_Commerce.objects.filter(pk=pk, is_published=False, author=request.user).first()
